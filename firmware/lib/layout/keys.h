...
// letters
KEYS__ALPHA(    a,              KEYBOARD__a_A                        );
KEYS__ALPHA(    b,              KEYBOARD__b_B                        );
KEYS__ALPHA(    c,              KEYBOARD__c_C                        );
KEYS__ALPHA(    d,              KEYBOARD__d_D                        );
KEYS__ALPHA(    e,              KEYBOARD__e_E                        );
KEYS__ALPHA(    f,              KEYBOARD__f_F                        );
KEYS__ALPHA(    g,              KEYBOARD__g_G                        );
KEYS__ALPHA(    h,              KEYBOARD__h_H                        );
KEYS__ALPHA(    i,              KEYBOARD__i_I                        );
KEYS__ALPHA(    j,              KEYBOARD__j_J                        );
KEYS__ALPHA(    k,              KEYBOARD__k_K                        );
KEYS__ALPHA(    l,              KEYBOARD__l_L                        );
KEYS__ALPHA(    m,              KEYBOARD__m_M                        );
KEYS__ALPHA(    n,              KEYBOARD__n_N                        );
KEYS__ALPHA(    o,              KEYBOARD__o_O                        );
KEYS__ALPHA(    p,              KEYBOARD__p_P                        );
KEYS__ALPHA(    q,              KEYBOARD__q_Q                        );
KEYS__ALPHA(    r,              KEYBOARD__r_R                        );
KEYS__ALPHA(    s,              KEYBOARD__s_S                        );
KEYS__ALPHA(    t,              KEYBOARD__t_T                        );
KEYS__ALPHA(    u,              KEYBOARD__u_U                        );
KEYS__ALPHA(    v,              KEYBOARD__v_V                        );
KEYS__ALPHA(    w,              KEYBOARD__w_W                        );
KEYS__ALPHA(    x,              KEYBOARD__x_X                        );
KEYS__ALPHA(    y,              KEYBOARD__y_Y                        );
KEYS__ALPHA(    z,              KEYBOARD__z_Z                        );
// --- (shifted) ---
...
// numbers
KEYS__ALPHA(    0,              KEYBOARD__0_RightParenthesis         );
KEYS__ALPHA(    1,              KEYBOARD__1_Exclamation              );
KEYS__ALPHA(    2,              KEYBOARD__2_At                       );
KEYS__ALPHA(    3,              KEYBOARD__3_Pound                    );
KEYS__ALPHA(    4,              KEYBOARD__4_Dollar                   );
KEYS__ALPHA(    5,              KEYBOARD__5_Percent                  );
KEYS__ALPHA(    6,              KEYBOARD__6_Caret                    );
KEYS__ALPHA(    7,              KEYBOARD__7_Ampersand                );
KEYS__ALPHA(    8,              KEYBOARD__8_Asterisk                 );
KEYS__ALPHA(    9,              KEYBOARD__9_LeftParenthesis          );
// --- (shifted) ---
...
// ---
KEYS__ALPHA(    bkslash,        KEYBOARD__Backslash_Pipe             );
KEYS__ALPHA(    brktL,          KEYBOARD__LeftBracket_LeftBrace      );
KEYS__ALPHA(    brktR,          KEYBOARD__RightBracket_RightBrace    );
KEYS__ALPHA(    comma,          KEYBOARD__Comma_LessThan             );
KEYS__ALPHA(    dash,           KEYBOARD__Dash_Underscore            );
KEYS__ALPHA(    equal,          KEYBOARD__Equal_Plus                 );
KEYS__ALPHA(    grave,          KEYBOARD__GraveAccent_Tilde          );
KEYS__ALPHA(    period,         KEYBOARD__Period_GreaterThan         );
KEYS__ALPHA(    quote,          KEYBOARD__SingleQuote_DoubleQuote    );
KEYS__ALPHA(    semicol,        KEYBOARD__Semicolon_Colon            );
KEYS__ALPHA(    slash,          KEYBOARD__Slash_Question             );
// --- (shifted) ---
...
KEYS__ALPHA(    bs,             KEYBOARD__DeleteBackspace            );
